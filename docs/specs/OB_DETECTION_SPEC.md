...
| R13 | Modèle de force — points ouverts (§3.2). **Arithmétique RÉSOLUE 2026-06-18** : 1 fois = 1 temps = 2 demi-paliers, échelle D1·H4·H1·M15 (`6eL9OUdSc94@00:43:18`). **Creusé 2026-06-19 (lecture directe)** : (c) RÉSOLU — à force égale = **NO-TRADE** (`HvbI6rA95tk@03:27:00` « +3 contre +3, on ne sait pas où va le marché ») → pas de règle de gagnant nécessaire, « premier POI » sans objet ; (e) RÉSOLU — zone-avant-OB « −1 temps » = code « −1 fois » = −2 demi-paliers (artefact d'unité). **RESTENT (vraies divergences de source Garry)** : (a) seuils épaisseur — `WO1gp3sk5U0@00:22:22` 3 paliers (1/1,65/2,65/2,7+) vs `24tpbSEAXeA@01:13:09` 2 paliers (0,75–1,5/≥1,5) ; (b) seuil contre-swing — 1 cm absolu (`WO1gp3sk5U0@00:44:27`) vs moitié du swing (`rwRNzxzzr10@00:08:55`, généralement plus strict) ; (d) contre-swing↔force_courante (déduction, mineur) | ⚠️ (a)(b) = choix humain ; DÉFÉRÉ au sous-système `force-energie.md` / `cartographie.py` |
